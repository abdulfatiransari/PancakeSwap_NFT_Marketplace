...
contract ERC721NFTMarketV1 is ERC721Holder, Ownable, ReentrancyGuard {
    ...
    mapping(address => Single) private _single; // Details about the single
    ...
    // Single is closed for trading and new listings
    event SingleNFTClose(address indexed collection, uint256 tokenId);
    ...
    function createAskOrder(
        ...
        require(
            _collections[_collection].status == CollectionStatus.Open || _single[_collection].status == CollectionStatus.Open,
